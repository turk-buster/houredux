...
NDiplomacy = {
	...
	WARGOAL_JUSTIFY_TENSION_FROM_PRODUCTION = 13.0,	-- Base value scaled by production capacity of country compared to biggest country
	...
	TENSION_SIZE_FACTOR = 0.5,						-- All action tension values are multiplied by this value
	...
	GUARANTEE_COST = 10,							-- Scale with the number of already guaranteed countries.
	REVOKE_GUARANTEE_COST = 10,
...
NDeployment = {
	BASE_DEPLOYMENT_TRAINING = 10,		-- Base training done each day during deployment.
},
...
NMilitary = {
	...
	CORPS_COMMANDER_CAP = 0,			-- how many a corps commander is limited to. 0 = inf
...
NAI = {
	...
	DIPLOMACY_CREATE_FACTION_FACTOR = 0.25,		-- Factor for AI desire to create a new faction. Val < 1.0 makes it less likely to create than to join.
	...
	MIN_ANTAGONIZE_FOR_WARGOAL_JUSTIFICATION = -1000,	-- AI countries will not fabricate claims against countries with an antagonization value lower than this.
	...
	WARGOAL_GENERATION_STRENGTH_FACTOR = 1.8,	-- Desire to generate wargoal effected negatevely if actor strength is less than this factor of target strength
	...
	DECLARE_WAR_NOT_NEIGHBOR_FACTOR = 1.0,		-- Multiplier applied before force factor if country is not neighbor with the one it is considering going to war
	...
	FASCISTS_ANTAGONIZE_FASCISTS = 200,
	FASCISTS_ANTAGONIZE_DEMOCRACIES = 100,
	FASCISTS_ANTAGONIZE_COMMUNISTS = 200,
	...
	COMMUNISTS_ANTAGONIZE_FASCISTS = 200,
	COMMUNISTS_ANTAGONIZE_DEMOCRACIES = 10,
	COMMUNISTS_ANTAGONIZE_COMMUNISTS = 200,
	...
	FORCE_FACTOR_AGAINST_EXTRA_MINOR = 0.6,			-- AI considers generating wargoals against minors below this % of force compared to themselves to get at a bigger enemy.
